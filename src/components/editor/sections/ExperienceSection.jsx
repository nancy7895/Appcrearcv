// =============================================================================
// SECCIÓN: EXPERIENCIA LABORAL (ExperienceSection.jsx)
// =============================================================================
    ...
    <div id="section-experience" className={`form-section ${!isOpen ? 'collapsed' : ''}`}>
      ...
      <div className="form-section-header" onClick={onToggle}>
        ...
        <div className="section-header-meta">
          <span className="section-count-badge">{experience.length}</span>
              ...
              {experience.map((item, idx) => (
                <div key={item.id} className="dynamic-item-card">
                  <div className="dynamic-item-top">
                    <div className="dynamic-item-title-wrapper">
                      ...
                      <span className="dynamic-item-title">
                        {item.role || 'Puesto'} {item.company ? `· ${item.company}` : ''}
                      </span>
                    </div>
                  ...
                  <div className="form-row">
                    ...
                    <div className="form-group">
                      <label className="form-label">Empresa o Organización *</label>
                      <input
                        type="text"
                        className="form-input"
                        value={item.company || ''}
                        onChange={(e) => handleUpdate(item.id, 'company', e.target.value)}
                        placeholder="Ej. Acme Corp / Remoto"
                      />
                    </div>
                  </div>
                  ...
                  <div className="form-row">
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        placeholder="2021-06 o Jun 2021"
                      />
                    </div>
                  </div>

                  {/* Fecha de Fin y Checkbox */}
                  <div className="form-row">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        value={item.current ? 'Presente (Actualidad)' : (item.endDate || '')}
                        onChange={(e) => handleUpdate(item.id, 'endDate', e.target.value)}
                        placeholder="2023-12 o Dic 2023"
                      />
                    </div>
                    <div className="form-group" style={{ justifyContent: 'center' }}>
                      <label style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', fontSize: '0.8rem', color: 'var(--text-secondary)', cursor: 'pointer', marginTop: '1.2rem' }}>
                        <input
                          type="checkbox"
                        ...
                        />
                        <span>Trabajo actualmente aquí</span>
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <textarea
                      ...
                      placeholder="• Lideré el desarrollo de nuevas funcionalidades aumentando la retención en un 25%..."
                    />
                  </div>
                </div>
              ))}
